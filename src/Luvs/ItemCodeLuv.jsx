...
const ItemCodeLuv = (props) => {
    ...
    const getItemCodeList = async () => {
        ...
        try {
            const result = await axios.post('/api/genericLuv/getItemCodeList', { page, where, orgId });
    ...
    useEffect(() => {
        getItemCodeList();
    }, [page, searchItemCode, searchItemCdeDesc]);
                            ...
                            <tbody>
                                {
                                    itemList.map((itemCode, index) => {
                                        return (
                                            <tr key={index} onClick={() => {props.funCall(itemCode, index); setsearchItemCode(''); setsearchItemCdeDesc(''); props.close(false);}} className='popUpTblBody'>
