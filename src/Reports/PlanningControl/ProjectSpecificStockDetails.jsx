...
import ProjectSpecificStkDtlHtml from '../../PrintsReport/PlanningAndControl/ProjectSpecificStockDetailHtml';


const ProjectSpecificStkDtlRep = () => {
    ...
    const getReports = async () => {
        ...
        try {
            ...
            if (data) {
                const oprName = '';
                ProjectSpecificStkDtlHtml(data, oprName, userId, repType);
            } else {
    ...
    const getReportData = async () => {
        ...
        try {
            const result = await axios.post('/api/reports/projects/MockUpDispatchRep/getProjectSpecStkDtl', { toDate, frDate, type });
        ...
        <div >
            ...
            <div className='parentDivPuForm' >
                ...
                <div className='formContDiv' style={{ width: '70%', marginLeft: helpScreen ? '2%' : 'auto', minHeight: '92vh', maxHeight: 'auto' }}>
                    <FormHeading adrmRightId='60307' headingText='Project Specific Stock Details' />
...
export default ProjectSpecificStkDtlRep;