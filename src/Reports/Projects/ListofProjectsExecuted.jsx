...
const ListofProjectsExecuted = () => {
    ...
    const getReports = async () => {
        ...
        try {
            ...
            setLoader(true);
            if(RepOptn === 'A'){
                path = '/reports/Projects/ListofProjectExecutedRep_WrtApprDt';
                RepName ='List of Projects Executed (WRT Apprvl Dt)';
            } else if(RepOptn === 'F'){
                path = '/reports/Projects/ListofProjectExecutedRep_FgBased';
                RepName ='List of Projects Executed (FG BASED)';
            } else if(RepOptn === 'I'){
                path = '/reports/Projects/ListofProjectExecutedRep';
                RepName ='List of Projects Executed (INVOICE BASED)';
            }
        ...
        <>
            ...
            <div className='parentDivEpForm ' style={blurBackgroundStyle}>
                ...
                <div className='formContDiv' style={{ width: helpScreen ? '75%' : '80%', marginLeft: helpScreen ? '2%' : 'auto' }}>
                    <FormHeading adrmRightId='343' headingText='List of Projects Executed' style={{ zIndex: '0' }} />
...
export default ListofProjectsExecuted;